...
@Component({
  selector: 'app-prodagric-indic-list',
  standalone: true,
  ...
  templateUrl: './prodagric-indic-list.component.html',
  styleUrl: './prodagric-indic-list.component.scss',
  animations: [
    trigger('listItem', [
      state('default', style({
        transform: 'scale(1)',
...
export class ProdagricIndicListComponent {
...
return this._http.get('http://154.127.90.218:8000/api/prodagric/get_prodagric_indicateur/'+params_debut+'-'+params_fin+'-'+params_pays+'-'+params_indicateur);
 ...
 /*  _getData_Indicator_Niveau_2(params_debut,params_fin,params_pays,params_indicateur) {
  ...
  getProdagricIndItemList(params_debut,params_fin,params_pays,params_indicateur): Observable<any> {
    ...
    return this._http.get('http://127.0.0.0:8000/api/prodagric/get_prodagric_niveau2/'+params_debut+'-'+params_fin+'-'+params_pays+'-'+params_indicateur);
  } */
   /*==============================================*/
