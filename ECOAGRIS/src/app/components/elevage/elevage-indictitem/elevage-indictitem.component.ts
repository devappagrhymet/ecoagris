...
@Component({
  selector: 'app-elevage-indictitem',
  standalone: true,
  ...
  templateUrl: './elevage-indictitem.component.html',
  styleUrl: './elevage-indictitem.component.scss',
  animations: [
    trigger('listItem', [
      state('default', style({
        transform: 'scale(1)',
...
export class ElevageIndictitemComponent {
...
#__________________Indicateur_______________________________
 ...
 /*==========================================*/
  ...
  _deleteIndicItem(id){
    ...
    if(id && result)
    {
        ...
        next: (res) => {
            ...
            this._getData_Indicator_Niveau_2(2014,2015,12,81);
        },
        error: console.log,
        });
    }
  ...
  printReport(): void{
    ...
    downloadLink.download = 'Indicateurs-elevage-report.xls';
    downloadLink.click();
