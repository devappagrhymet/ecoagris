...
@Component({
  selector: 'app-agricole-indic-list',
  standalone: true,
  ...
  templateUrl: './agricole-indic-list.component.html',
  styleUrl: './agricole-indic-list.component.scss',
  animations: [
    trigger('listItem', [
      state('default', style({
        transform: 'scale(1)',
...
export class AgricoleIndicListComponent {
