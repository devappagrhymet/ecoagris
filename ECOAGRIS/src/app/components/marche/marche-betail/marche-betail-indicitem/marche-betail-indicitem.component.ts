...
@Component({
  selector: 'app-marche-betail-indicitem',
  standalone: true,
...
templateUrl: './marche-betail-indicitem.component.html',
styleUrl: './marche-betail-indicitem.component.scss',
animations: [
    trigger('listItem', [
      state('default', style({
        transform: 'scale(1)',
...
export class MarcheBetailIndicitemComponent {
