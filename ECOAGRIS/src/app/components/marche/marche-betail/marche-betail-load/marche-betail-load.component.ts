...
@Component({
  selector: 'app-marche-betail-load',
  standalone: true,
  ...
  templateUrl: './marche-betail-load.component.html',
  styleUrl: './marche-betail-load.component.scss',
  animations: [
    trigger('listItem', [
      state('default', style({
        transform: 'scale(1)',
...
export class MarcheBetailLoadComponent {
                ...
                { 
                  ...
                  { 
                   ...
                   /*  this.indIicateurItemForm.patchValue({
                        ...
                        speculation:             productionData[i]["source"],
                        indicateur:              86,
                        espece:                  productionData[i]["categoriebet"]["nomCategorie"],
                        nom_marche:              productionData[i]["marche"]["nomMarche"],
                        type_prix:               productionData[i]["race"]["nomRace"],
                        code_unite:              productionData[i]["etatembompoint"],
                        code_devise:             productionData[i]["devise"],
                        divisionadministrative:  productionData[i]["niveau2_id"],
                        niveau1_id:              productionData[i]["niveau1_id"],
                        pays_id:                 productionData[i]["pays_id"],
  ...
  _loadMarcheBetailData(): Observable<any> {
      ...
      let url;
      if(annee && pays){
        url = this._http.get('http://154.127.90.218:8000/api/marche/prix_betail?annee='+annee+'&pays='+pays)
      }
      else
      { 
        url = "";
  ...
  getData_Indicator_Pays(params_debut,params_pays): Observable<any> {
     ...
     return this._http.get('http://154.127.90.218:8000/api/marche/get_marche_betail_pays/'+params_debut+'-'+params_pays)
  }
