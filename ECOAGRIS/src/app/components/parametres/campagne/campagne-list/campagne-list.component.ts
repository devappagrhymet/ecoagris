...
import { CampagneAddEditComponent } from '../campagne-add-edit/campagne-add-edit.component';
...
export class CampagneListComponent {
  ...
  openAddTaskDialog(enterAnimationDuration: string, exitAnimationDuration: string): void {
      this.dialog.open(CampagneAddEditComponent, {
          width: '600px',
  ...
  displayedColumns: string[] = ['id', 'annee_debut', 'annee_fin', 'action'];
